...
export abstract class BaseAdapter implements AIToolAdapter {
  ...
  protected sortRules(
    ...
    return [...rules].sort((a, b) => {
      ...
      if (actualSortBy === 'id') {
        ...
        comparison = aPriority - bPriority; // asc: low(1) -> high(3), desc: high(3) -> low(1)
      }
  ...
  protected generateFileHeader(toolName: string, ruleCount: number): string {
    ...
    header += '> To add custom rules, create files in the `ai-rules/` directory.\n';
    header += '> See documentation: https://github.com/ygqygq2/turbo-ai-rules\n\n';
    return header;
  }
