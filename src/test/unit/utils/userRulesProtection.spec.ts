...
describe('userRulesProtection 单元测试', () => {
  ...
  describe('isUserDefinedFile', () => {
    ...
    it('应该将无前缀文件视为自动生成文件', () => {
      expect(isUserDefinedFile('readme.md', enabledConfig)).toBe(false);
      expect(isUserDefinedFile('my-custom-rules.md', enabledConfig)).toBe(false);
    });
  ...
  describe('isAutoGeneratedFile', () => {
    ...
    it('应该将无前缀文件视为自动生成文件', () => {
      expect(isAutoGeneratedFile('readme.md', enabledConfig)).toBe(true);
    });
