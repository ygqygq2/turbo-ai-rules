...
import { activateWorkspace, getExtensionServices, sleep } from '../testHelpers';
...
describe('Error Handling Tests', () => {
  ...
  before(async function () {
    ...
    // 查找 "Scenarios: Error Handling" 工作空间
    workspaceFolder =
      folders.find(
        (f) => f.name === 'Scenarios: Error Handling' || f.uri.fsPath.includes('errorHandling'),
      ) || folders[0];
