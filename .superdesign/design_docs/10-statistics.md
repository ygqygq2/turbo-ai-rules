...
**页面类型**: Webview  
**实现文件**: `src/webview/statistics/App.tsx`  
**访问方式**: 树视图工具栏图标 / 命令面板
...
│  Sources Overview                                │
│  ┌──────────────────────────────────────────┐   │
│  │ Source Name         Rules  Status  Last Sync │
│  ├──────────────────────────────────────────┤   │
│  │ company-rules        89  Enabled    2m ago   │
│  │ personal-rules       67  Enabled    5m ago   │
│  │ archived-rules       0  Disabled     Never   │
│  └──────────────────────────────────────────┘   │
│                                                  │
│  Top Tags                                        │
│  ┌──────────────────────────────────────────┐   │
